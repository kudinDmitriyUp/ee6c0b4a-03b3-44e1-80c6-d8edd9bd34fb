...
export const metadata: Metadata = {
  title: "Lorenzo Noya - Master Italian Barber | Luxury Barbering Services",
  description: "Experience premium Italian barbering with Lorenzo Noya. Expert haircuts, beard sculpting, and hot towel shaves using traditional techniques and luxury products.",
  keywords: "Italian barber, luxury barbering, master barber, Lorenzo Noya, haircuts, beard grooming, hot towel shave, premium barbering services",
  metadataBase: new URL("https://webild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763325472639-hvsoenhr.jpg"),
  alternates: {
    canonical: "https://webild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763325472639-hvsoenhr.jpg"
  },
  openGraph: {
    title: "Lorenzo Noya - Master Italian Barber",
    description: "Experience the artistry of traditional Italian barbering with modern sophistication.",
    siteName: "Lorenzo Noya Barbering",
    images: [{
      url: "https://webild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763325472639-hvsoenhr.jpg",
      alt: "Lorenzo Noya master Italian barber"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Lorenzo Noya - Master Italian Barber",
    description: "Experience the artistry of traditional Italian barbering with modern sophistication.",
    images: ["https://webild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763325472639-hvsoenhr.jpg"]
  },
  robots: {
    index: true,
    follow: true
